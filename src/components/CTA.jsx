...
const CTA = () => (
  <section className="relative flex h-screen w-full p-12 flex-col items-center justify-center overflow-hidden bg-neutral-900 text-white">
    ...
    <div className="z-10 flex flex-col md:flex-row bg-neutral-600 w-auto border justify-evenly rounded-4xl p-12 items-center">
      ...
      >
        ...
        <div className="flex flex-col md:flex-row space-x-5 justify-center items-center md:items-start md:justify-start">
          <motion.img
