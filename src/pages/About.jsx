        ...
        <section className="flex min-h-screen w-full flex-col-reverse items-center bg-neutral-900 p-8 py-32 md:flex-row md:p-24">
          ...
          >
            ...
            <motion.img
              ...
              className="h-[400px] sm:h-[600px] object-cover rounded-2xl filter grayscale hover:grayscale-0 transition-all duration-700 ease-in-out hover:scale-105 shadow-xl"
